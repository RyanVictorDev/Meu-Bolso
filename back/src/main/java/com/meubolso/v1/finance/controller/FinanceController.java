package com.meubolso.v1.finance.controller;

import com.meubolso.v1.finance.service.FinanceService;
...
public class FinanceController {
    ...
    public CategoryDto updateCategory(
        ...
        return financeService.updateCategory(user.id(), environmentId, categoryId, request);
    }
    ...
    public void deleteCategory(
        ...
        financeService.deleteCategory(user.id(), environmentId, categoryId);
    }
